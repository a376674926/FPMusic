...
public class MediaPlaybackService extends Service {
    ...
    private Notification mStatusNotification = new Notification();
    ...
    private void setNextTrack() {
        if (!MusicUtils.isSurpportGaplessPlayback(getApplicationContext())) {
    ...
    public void play() {
        ...
        if (mRemoteViews != null && mStatusNotification != null && mControlInStatusBar) {
            // Reset notification play function to pause function
            mRemoteViews.setImageViewResource(R.id.pause, android.R.drawable.ic_media_pause);
            ...
            mRemoteViews.setOnClickPendingIntent(R.id.pause, pausePendingIntent);
            startForeground(PLAYBACKSERVICE_STATUS, mStatusNotification);
        }
    }

    private void updateNotification() {
        mRemoteViews = new RemoteViews(getPackageName(), R.layout.statusbar);
        ...
        mRemoteViews.setOnClickPendingIntent(R.id.prev, prevPendingIntent);
        ...
        mRemoteViews.setOnClickPendingIntent(R.id.pause, togglePendingIntent);

        Intent nextIntent = new Intent(NEXT_ACTION);
        PendingIntent nextPendingIntent = PendingIntent.getBroadcast(this,
                0 /* no requestCode */, nextIntent, 0 /* no flags */);
        mRemoteViews.setOnClickPendingIntent(R.id.next, nextPendingIntent);

        if (mControlInStatusBar) {
            mRemoteViews.setViewVisibility(R.id.exit, View.VISIBLE);
            mRemoteViews.setImageViewResource(R.id.exit, R.drawable.exit);
            ...
            mRemoteViews.setOnClickPendingIntent(R.id.exit, exitPendingIntent);
        }

        if (getAudioId() < 0) {
            // streaming
            mRemoteViews.setTextViewText(R.id.trackname, getPath());
            mRemoteViews.setTextViewText(R.id.artistalbum, null);
        } else {
            String artist = getArtistName();
            mRemoteViews.setTextViewText(R.id.trackname, getTrackName());
            ...
            mRemoteViews.setTextViewText(R.id.artistalbum,
                    getString(R.string.notification_artist_album, artist, album)
                    );
        }

        mRemoteViews.setImageViewResource(R.id.pause, (isPlaying() ?
                R.drawable.ic_appwidget_music_pause :
                R.drawable.ic_appwidget_music_play));
        mStatusNotification = new Notification();
        mStatusNotification.contentView = mRemoteViews;
        mStatusNotification.flags |= Notification.FLAG_ONGOING_EVENT;
        mStatusNotification.icon = R.drawable.stat_notify_musicplayer;
        mStatusNotification.contentIntent = PendingIntent.getActivity(this, 0,
        ...
        synchronized(this) {
            ...
            if (isPlaying()) {
                ...
                if (mControlInStatusBar) {
                    ...
                    mRemoteViews.setImageViewResource(R.id.pause, android.R.drawable.ic_media_play);
                    ...
                    mRemoteViews.setOnClickPendingIntent(R.id.pause, playPendingIntent);
                    startForeground(PLAYBACKSERVICE_STATUS, mStatusNotification);
                }
            }
        }
